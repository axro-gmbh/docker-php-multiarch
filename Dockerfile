...
LABEL org.opencontainers.image.title="PHP 8.2 FPM (Alpine) for Symfony" \
      org.opencontainers.image.description="PHP 8.2 FPM on Alpine with common extensions, APCu, Composer, supercronic, and developer tools." \
      org.opencontainers.image.version="8.2-fpm-alpine" \
