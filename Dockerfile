...
LABEL org.opencontainers.image.title="PHP 8.3 FPM (Alpine) for Symfony" \
      org.opencontainers.image.description="PHP 8.3 FPM on Alpine with common extensions, APCu, Composer, supercronic, and developer tools." \
      org.opencontainers.image.version="8.3-fpm-alpine" \
